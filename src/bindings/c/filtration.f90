...
!#########################################################################
! 
subroutine calculate_flow_c(mesh_type, mesh_type_len,&
 grav_dirn, grav_factor, bc_type, bc_type_len, inlet_bc, outlet_bc,&
  L_p, sigma, pi_c, pi_alv, c_L) bind(C, name="calculate_flow_c")
...
call so_calculate_flow(mesh_type_f, grav_dirn, grav_factor,&
 bc_type_f, inlet_bc, outlet_bc, L_p, sigma, pi_c, pi_alv, c_L)
#else
call calculate_flow(mesh_type_f, grav_dirn, grav_factor, &
bc_type_f, inlet_bc, outlet_bc, L_p, sigma, pi_c, pi_alv, c_L)
#endif
